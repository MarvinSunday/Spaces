...
contract QuadraticDAOFactoryTest is Test {
    QuadraticDAOFactory internal factory;
    ...
    function setUp() public {
        ...
        gov = QuadraticGovernance(governanceAddr);
    ...
    function test_CreateDAO_RevertsOnInvalidConfig() public {
        QuadraticGovernance.QuadraticGovernanceConfig memory badConfig = defaultConfig();
        badConfig.quorumBps = 0;

        vm.prank(creator);
        vm.expectRevert(QuadraticGovernance.InvalidConfiguration.selector);
